...
class Banco():
        ...
        while atendimento:
            ...
            while conta_usuario is None:
                try:
                    ...
                    num_conta_usuario = input("Digite o Numero de sua Conta (q para sair): ")
            ...
            if (conta_usuario.valida_senha(senha_usuario)):
                ...
                while op !=6:
                    try:
                        op = int(input("Digite a opção desejada: 1) Ver Saldo 2) Realizar Saque 3) Realizar Depósito 4) Simular Rendimentos 5) Ver número do cartão de crédito 6) Sair: "))
                        if op == 1:
                            print(f'Seu saldo é de: R${conta_usuario.get_saldo(senha_usuario)}')
                        elif op == 2:
                            conta_usuario.saque(senha_usuario,int(input("Digite o valor do saque: ")))
                        elif op == 3:
                            conta_usuario.deposito(int(input("Digite o valor do depósito: ")))
                        elif op == 4:
                            if isinstance(conta_usuario,ContaPoupanca):
                                conta_usuario.simula_rendimentos(int(input("Digite o número de meses: ")))
                            else:
                                print("Esta conta não é do tipo poupança")
                        elif op == 5:
                            if isinstance(conta_usuario,ContaCorrente):
                                print("Número do cartão do usuário: ",conta_usuario.get_num_cartao(senha_usuario))
                            else:
    ...
    def atendimento_gerente(self):
        ...
        if self.valida_senha(int(input("Digite a senha de gerente: "))):
            ...
            while op !=2:
                try:
                    op = int(input("Digite a operacao desejada: 1) Cadastrar uma nova conta 2) Sair: "))
                    if int(op) == 1:
                        tipo = input("Digite o tipo de conta: 1) Padrão 2) Poupança 3) Corrente: ")
                        if tipo == '1':
                            nc = self.cadastra_conta(input("Digite o Titular da Conta: "),senha=int(input("Digite a senha da conta: ")),saldoi=float(input("Digite o saldo inicial da conta: ")))
                        elif tipo == '2':
                            nc = self.cadastra_conta(input("Digite o Titular da Conta: "),senha=int(input("Digite a senha da conta: ")),saldoi=float(input("Digite o saldo inicial da conta: ")),taxa=float(input("Digite a taxa de juros: ")))
                        elif tipo=='3':
                            nc = self.cadastra_conta(input("Digite o Titular da Conta: "),senha=int(input("Digite a senha da conta: ")),saldoi=float(input("Digite o saldo inicial da conta: ")),ncartao=input("Digite o número do cartão: "))
                        else:
                            pass
    ...
    def cadastra_conta(self, titular, senha,saldoi=0.0,taxa=None,ncartao=None)->int:
        ...
        if taxa is not None:
            ...
            c = Conta(num_conta_nova,titular,senha,saldoi)
